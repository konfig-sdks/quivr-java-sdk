...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.quivr.app";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("AuthBearer", new HttpBearerAuth("bearer"));
    ...
    private void init() {
        ...
        setUserAgent("Konfig/0.1.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.quivr.app)
