...
public class ApiKeyInfo {
  ...
  public ApiKeyInfo keyId(String keyId) {
  ...
  **/
  ...
  public ApiKeyInfo creationTime(String creationTime) {
  ...
  **/
   ...
   * @return the ApiKeyInfo instance itself
   */
  public ApiKeyInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyId, apiKeyInfo.keyId) &&
        Objects.equals(this.creationTime, apiKeyInfo.creationTime)&&
        Objects.equals(this.additionalProperties, apiKeyInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyId, creationTime, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApiKeyInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ApiKeyInfo>() {
           ...
           public ApiKeyInfo read(JsonReader in) throws IOException {
             ...
             ApiKeyInfo instance = thisAdapter.fromJsonTree(jsonObj);
